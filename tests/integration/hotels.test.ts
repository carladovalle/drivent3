...
import { createEnrollmentWithAddress, createUser, createTicketType, createTicket, createHotel, createRoom, createTicketTypeWithHotel } from "../factories";
...
describe("GET /hotels/:hotelId", () => {
  ...
  describe("when token is valid", () => {
    ...
    it("should respond with status 401 when doesnt have hotel with given id", async () => {
      const user = await createUser();
      const token = await generateValidToken(user);
      const enrollment = await createEnrollmentWithAddress(user);
